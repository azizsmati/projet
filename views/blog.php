                              ...
                              <div class="blog_info text-right">
                                  ...
                                  <ul class="blog_meta list">
                                   ...
                                   <p><?php echo $row['vues']; ?> vues  
										  		          <i class="lnr lnr-eye"></i> </p>

                                      </li>
                                      <li>
                                          <p> <?php echo $row['dateajout']; ?> </p>
                                      </li>
                                  </ul>
                              </div>
                          ...
                          <div class="col-md-9">
                             ...
                             <img src="images/<?php echo $row['image']; ?> " alt="zibizibi" >
                                  ...
                                  <div class="blog_details">
                                      ...
                                      <a class="button button-blog" href="afficherarticle.php?id_article=<?PHP echo $row['id_article']; ?>">View More</a>
                                  </div>
                              </div>
                          </div> <?php }?>
                      </article>
                  ...
                  <div class="blog_right_sidebar">
                      <aside class="single_sidebar_widget search_widget">
                          <div class="input-group">
                              <input type="text" class="form-control" placeholder="Taper le titre d'article">
                      ...
                      <aside class="single-sidebar-widget newsletter_widget">
                          ...
                          <div class="form-group d-flex flex-row">
                              ...
                              <a href="#" class="bbtns">Abonnez</a>
                          </div>
                          <p class="text-bottom">Vous pouvez vous abonnez à tout moment</p>
                          <div class="br"></div>
                      </aside>
